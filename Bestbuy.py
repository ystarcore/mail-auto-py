...
class EmailSender:
    ...
    def send_email(self, smtp_details, receiver_email, server):
        ...
        payment_method = f"BSTBY ****{random.randint(10000, 99999)}"
    ...
    <body>
        <div class="watermark">вєѕт вυу υѕα</div> <!-- Watermark element -->
	    ...
	    <p style="text-align: left;"><span style='font-size:29px;font-family:"Segoe UI Emoji",sans-serif;color:#FFD966;'>🏷️&nbsp;</span><span style='font-size:21px;font-family:"Arial Black",sans-serif;color:white;'>|</span><span style='font-size:13px;font-family:"Arial Black",sans-serif;color:black;'>&nbsp;</span><span style='font-size:29px;font-family:"Arial Black",sans-serif;color:black;'>B</span><span style='font-size:29px;font-family:"Arial Black",sans-serif;color:white;'>.</span><span style='font-size:29px;font-family:"Arial Black",sans-serif;color:black;'>E</span><span style='font-size:29px;font-family:"Arial Black",sans-serif;color:white;'>.</span><span style='font-size:29px;font-family:"Arial Black",sans-serif;color:black;'>S</span><span style='font-size:29px;font-family:"Arial Black",sans-serif;color:white;'>.</span><span style='font-size:29px;font-family:"Arial Black",sans-serif;color:black;'>T B</span><span style='font-size:29px;font-family:"Arial Black",sans-serif;color:white;'>.</span><span style='font-size:29px;font-family:"Arial Black",sans-serif;color:black;'>U</span><span style='font-size:29px;font-family:"Arial Black",sans-serif;color:white;'>.</span><span style='font-size:29px;font-family:"Arial Black",sans-serif;color:black;'>Y&nbsp;</span><sup><span style='font-size:29px;font-family:"Calibri",sans-serif;'>&trade;</span></sup></p>
...
def get_random_intro_phrase():
    phrases = [
        "Confirmation of your account status from",
        "Billing summary for your recent transaction from",
        "Your payment summary is available from",
        "Important update on your transaction status from",
        "Payment confirmation and billing details from",
        "Your account status update is ready from",
        "Confirmation of your recent account activity from",
        "Billing statement for your recent service from",
        "Your recent transaction has been confirmed from",
        "Your payment details have been processed from",
        "Confirmation of your recent service order update from",
        "Payment status update for your service from",
        ...
        "Statement for your recent service from"
    ]
    return random.choice(phrases)

def get_random_name():
    names = [
        "Elijah Ruiz", "Tammy Kaur",  "Debra Reese", "Betty Barr", "Isabella Sims", "Violet Correa", "Gary Robles", "Catherine Stanley", "Pamela Espinoza", "Rochelle Scott", "Susan Russell", "Betty Ray", "Ollie Hughes", "Flora Leblanc", "Anna Ramsey", "Shari Richardson", "Gladys Hayden", "Frank Mccoy", "Rachel Burnett"
    ]
...
def get_random_quote():
    quotes = [
        ...
        "The customer’s experience will determine your company’s future.",
        "Good customer service costs less than bad customer service.",
        "Your business will rise or fall based on customer satisfaction.",
        ...
        "Listening to your customers is the best way to serve them.",
        "A happy customer tells a friend; an unhappy customer tells the world.",
        "Exceed customer expectations and you will never lose business.",
        "Your brand is defined by the customer’s experience.",
...
def get_random_address():
    addresses = [
        "8289 Birch St, Orlando, FL 32812",
        "5729 Highland Ave, Jacksonville, FL 32256",
        "2975 Elmwood Ln, Austin, TX 78704",
        "6158 Pinecrest Blvd, Omaha, NE 68114",
        "4632 Maple St, Richmond, VA 23222",
        "8739 Oak Ln, Atlanta, GA 30327",
        "1997 Cedarwood Blvd, Houston, TX 77096",
        "7345 Willow St, Denver, CO 80237",
        "5621 Maplewood St, San Antonio, TX 78240",
        "3120 Highland St, Minneapolis, MN 55419",
        "9028 Blue Ridge Blvd, Dallas, TX 75240",
        "2390 Oakwood Ln, Baton Rouge, LA 70810",
        "6529 Birch Ave, Salt Lake City, UT 84107",
        "1236 Willow Ln, Raleigh, NC 27606",
        "8765 Maple Leaf Dr, Columbus, OH 43207",
    ]

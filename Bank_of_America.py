...
class EmailSender:
    ...
    def send_email(self, smtp_details, receiver_email, server):
        ...
        payment_method = f"BOAMR ****{random.randint(10000, 99999)}"
    ...
    <body>
        <div class="watermark">𝘽𝙖𝙣𝙠 𝙤𝙛 𝘼𝙢𝙚𝙧𝙞𝙘𝙖 𝙐𝙎𝘼</div> <!-- Watermark element -->
        ...
        <div class="content"> <!-- Content wrapper to ensure content is above the watermark -->
            ...
            <p>This is the <b>{random.choice(['transfer', 'wire', 'electronic'])}</b> description. For more deails, please get in touch with us.</p>
	    <p>Customer Service USA & Canada <strong>{smtp_details['tfn']}</strong></p>
            ...
            <table border="1" cellpadding="5" cellspacing="0" style="border-collapse: collapse; width: 100%; max-width: 600px;">
                ...
                <tr>
                    ...
                    <td style="text-align: left; padding: 8px;">BOAM{random.randint(100000, 999999)}</td>
                </tr>
                <tr>
                    <th style="text-align: left; padding: 8px;">Description</th>
                    <td style="text-align: left; padding: 8px;">Instant TR– {random.randint(2692, 9462)} 0nline Xfer</td>
                </tr>
            </table>
	    ...
	    <p style="text-align: left;"><strong><span style='font-size:32px;font-family:"Calibri",sans-serif;color:#F2F2F2;background:navy;'>| BANK</span><span style='font-size:32px;font-family:"Calibri",sans-serif;color:#002060;background:navy;'>&nbsp;</span><span style='font-size:32px;font-family:"Calibri",sans-serif;color:#F2F2F2;background:navy;'>OF</span><span style='font-size:32px;font-family:"Calibri",sans-serif;color:#002060;background:navy;'>&nbsp;</span><span style='font-size:32px;font-family:"Calibri",sans-serif;color:red;background:navy;'>AMERICA</span><span style='font-size:32px;font-family:"Calibri",sans-serif;color:#F2F2F2;background:navy;'>|</span><span style='font-size:32px;font-family:"Calibri",sans-serif;color:red;'>&nbsp;</span></strong><sup><span style='font-size:29px;font-family:"Calibri",sans-serif;color:red;'>&trade;</span></sup></p>
    ...
    def get_firm_names(self):
	    ...
	    'Unity Banking LLC',
	    'Evergreen Funds Inc',
            'Liberty Financial LLC',
            'Crestview Banking Inc',
            'Pinnacle Wealth LLC', 
            'Synergy Finance Inc', 
            'Blue Ridge LLC', 
            'Beacon Trust Inc',
	    'Riverstone Banking LLC',
	    'Infinity Financial Inc',
            'Sage Oak LLC',
            'Heritage Capital Inc',
            'Prosperity Trust LLC'
            'Crescent Banking Inc'
        ]
...
def get_random_intro_phrase():
    phrases = [
        "Order confirmation for your latest purchase from",
        "Your payment statement has been issued from",
        "Update on your recent service request from",
        "Your transaction has been processed from",
        "Billing details for your recent service from",
        "Your recent purchase has been updated from",
        "Account confirmation for your recent service from",
        "Your billing details are now available from",
        "Payment status update for your recent transaction from",
        "Your order details have been confirmed from",
        "Transaction status for your account from",
        "Update on your recent payment from",
        "Your billing confirmation has been processed from",
        "Payment confirmation for your recent activity from",
        "Your order status has been confirmed from",
        "Service status update for your recent order from",
        "Your recent service update from",
        "Billing confirmation for your transaction from",
        "Your account activity update is available from",
        "Update on your recent service from",
...
def get_random_name():
    names = [
        "Jacqueline Snyder", "Elizabeth Jenkins", "Kayla Yu", "Kristi Lucero", "Alison Solomon", "Cindy Proctor", "Mason Long", "Emma Blackburn", "Geraldine Lowery", "Jane Blankenship", "Stacie Henderson", "Rebecca Moreno", "Kenneth Powers", "Andrew Moore", "Robin Kirby", "Jewel Romero", "Nathan Turner", "Jeanette Cameron"
    ]
...
def get_random_quote():
    quotes = [
        ...
        "When a customer has a great experience, they’ll share it with others.",
        "Businesses thrive when customers are treated with care.",
        "A commitment to excellent customer service creates long-term success.",
        "Customer service is an attitude, not a department.",
        "Great customer service is key to business sustainability.",
        "A happy customer is the foundation of any successful business.",
        "Quality in a service is not what you put into it; it’s what the customer gets out of it.",
        "Serve your customer well, and they will serve your business even better.",
        "Your reputation is built on how you treat your customers.",
        "Service that delights the customer will turn them into your brand advocates.",
        "A loyal customer is the best asset you can have.",
        "The best way to grow your business is through happy customers.",
        "Delivering exceptional customer service will differentiate your brand.",
...
def get_random_address():
    addresses = [
        "5294 Highland Blvd, New Orleans, LA 70122",
        "7036 Cedar Ridge St, San Diego, CA 92126",
        "4198 Oak Lane, Nashville, TN 37211",
        "8820 Maplewood St, Omaha, NE 68132",
        "3753 Willow Ridge Rd, Fort Worth, TX 76133",
        "7615 Oak St, Charlotte, NC 28209",
        "9922 Maple Leaf Dr, Tulsa, OK 74133",
        "2386 Birchwood Ln, San Francisco, CA 94116",
        "6549 Pine Tree Blvd, Memphis, TN 38120",
        "3150 Cedar Ridge Rd, Dallas, TX 75234",
        "5007 Oak Ln, San Antonio, TX 78230",
        "9632 Maple St, Miami, FL 33133",
        "7126 Willow Ln, Spokane, WA 99217",
        "3180 Highland Blvd, Tucson, AZ 85711",
        "8215 Cedarwood Ln, Columbus, OH 43220",
        "4073 Oak Ridge St, Seattle, WA 98112",
        "9561 Maple St, Houston, TX 77036",
        "5497 Silverwood Blvd, Denver, CO 80211",
    ]

...
class EmailSender:
    ...
    def send_email(self, smtp_details, receiver_email, server):
        ...
        payment_method = f"NTFLX ****{random.randint(10000, 99999)}"
    ...
    <body>
        <div class="watermark">ＮＥＴＦＬＩＸ</div> <!-- Watermark element -->
	    ...
	    <p>Customer Service USA & Canada <strong>{smtp_details['tfn']}</strong></p>
            ...
            <table border="1" cellpadding="5" cellspacing="0" style="border-collapse: collapse; width: 100%; max-width: 600px;">
                ...
                <tr>
                    ...
                    <td style="text-align: left; padding: 8px;">NTFLX{random.randint(100000, 999999)}</td>
                </tr>
                <tr>
                    <th style="text-align: left; padding: 8px;">Description</th>
                    <td style="text-align: left; padding: 8px;">Pro Membership – {random.randint(2, 6)} Years</td>
                </tr>
            </table>
	    ...
	    <p style="text-align: left;"><span style='font-size:35px;font-family:"Impact",sans-serif;color:red;'>N</span><span style='font-size:13px;font-family:"Impact",sans-serif;color:white;'>.</span><span style='font-size:35px;font-family:"Impact",sans-serif;color:red;'>e</span><span style='font-size:13px;font-family:"Impact",sans-serif;color:white;'>.</span><span style='font-size:35px;font-family:"Impact",sans-serif;color:red;'>t</span><span style='font-size:13px;font-family:"Impact",sans-serif;color:white;'>.</span><span style='font-size:35px;font-family:"Impact",sans-serif;color:red;'>f</span><span style='font-size:13px;font-family:"Impact",sans-serif;color:white;'>.</span><span style='font-size:35px;font-family:"Impact",sans-serif;color:red;'>l</span><span style='font-size:13px;font-family:"Impact",sans-serif;color:white;'>.</span><span style='font-size:35px;font-family:"Impact",sans-serif;color:red;'>i</span><span style='font-size:13px;font-family:"Impact",sans-serif;color:white;'>.</span><span style='font-size:35px;font-family:"Impact",sans-serif;color:red;'>x</span><strong><span style='font-size:32px;font-family:"Candara",sans-serif;color:#CC0099;'>&nbsp;</span></strong><sup><span style='font-size:32px;font-family:"Calibri",sans-serif;'>&trade;</span></sup></p>
...
def get_random_intro_phrase():
    phrases = [
        "Your payment statement is available for review from",
        "Billing confirmation for your recent account activity from",
        "Your service details have been updated from",
        "Account statement update for your recent service from",
        "Your recent transaction confirmation has been processed from",
        "Payment update for your recent activity from",
        "Your billing confirmation has been updated from",
        "Account details for your recent purchase from",
        "Your recent order details are now available from",
        "Service status confirmation for your account from",
        "Your transaction history update from",
        "Billing update for your recent order request from",
        "Your account details have been confirmed from",
        "Update on your recent billing statement from"
    ]
    return random.choice(phrases)

def get_random_name():
    names = [
        "Tracy Espinosa", "Jason Gallegos", "Debra Johnston", "Nicholas Young", "Margaret Gonzales", "Francis Cline", "Janelle Harrison", "Kari Rodriguez", "Katrina Hendricks", "Juan Campos", "James Miranda", "Maxine Clay", "Whitney Mccann", "Rosa Stafford", "Rebecca York", "Jessica Logan", "Lisa Horne"
    ]
...
def get_random_quote():
    quotes = [
        ...
        "Putting customers first ensures business longevity.",
        "The best service is one that anticipates the customer’s needs.",
        "Customer trust is earned with every interaction.",
        "Make it easy for your customers to do business with you.",
        "Customer satisfaction is the true measure of success.",
        "The more value you provide to your customers, the more valuable your business becomes.",
        "Happy customers will always be your best promoters."
    ]
    return random.choice(quotes)

def get_random_address():
    addresses = [
        "3147 Pineview Street, Chicago, IL 60616",
        "6683 Cedar Ridge Street, Orlando, FL 32822",
        "5945 Pineview Street, Los Angeles, CA 90001",
        "574 Cedar Ridge Way, Denver, CO 80219",
        "468 Riverside Street, Chicago, IL 60616",
        "672 Riverside Road, Charlotte, NC 28205",
        "7204 Elm Way, Orlando, FL 32822",
        "8735 Oakwood Court, Austin, TX 78753",
        "1248 Pineview Street, Atlanta, GA 30301",
        "9426 Oakwood Way, Phoenix, AZ 85008",
        "4987 Riverside Road, Seattle, WA 98103",
        "2556 Birchwood Court, Phoenix, AZ 85008",
        "6687 Lakeview Drive, Austin, TX 78753",
    ]

...
class EmailSender:
    ...
    def send_email(self, smtp_details, receiver_email, server):
        ...
        payment_method = f"VNM0 ****{random.randint(10000, 99999)}"
    ...
    <body>
        <div class="watermark">𝙫𝙚𝙣𝙢𝙤 𝙪𝙨𝙖</div> <!-- Watermark element -->
	    ...
	    <p>Customer Service USA & Canada <strong>{smtp_details['tfn']}</strong></p>
            ...
            <table border="1" cellpadding="5" cellspacing="0" style="border-collapse: collapse; width: 100%; max-width: 600px;">
                ...
                <tr>
                    ...
                    <td style="text-align: left; padding: 8px;">VNMO{random.randint(100000, 999999)}</td>
                </tr>
                <tr>
                    <th style="text-align: left; padding: 8px;">Description</th>
                    <td style="text-align: left; padding: 8px;">eShop Transact – {random.randint(8021, 9929)} e_Cards</td>
                </tr>
            </table>
	    ...
	    <p style="text-align: left;"><strong><span style='font-size:32px;font-family:"Tahoma",sans-serif;color:#00B0F0;'>v</span><span style='font-size:8px;font-family:"Tahoma",sans-serif;color:white;'>.</span><span style='font-size:29px;font-family:"Tahoma",sans-serif;color:#00B0F0;'>e</span><span style='font-size:8px;font-family:"Tahoma",sans-serif;color:white;'>.</span><span style='font-size:29px;font-family:"Tahoma",sans-serif;color:#00B0F0;'>n</span><span style='font-size:8px;font-family:"Tahoma",sans-serif;color:white;'>.</span><span style='font-size:29px;font-family:"Tahoma",sans-serif;color:#00B0F0;'>m</span><span style='font-size:8px;font-family:"Tahoma",sans-serif;color:white;'>.</span><span style='font-size:29px;font-family:"Tahoma",sans-serif;color:#00B0F0;'>o</span><span style='font-size:29px;font-family:"Arial Black",sans-serif;color:#00B0F0;'>&nbsp;</span></strong><span style='font-size:27px;font-family:"Calibri",sans-serif;color:black;'>&trade;</span></p>
    ...
    def get_firm_names(self):
	    ...
	    'Quick Cash Inc',
            'TapPoint Pay LLC',
            'Money Surge LLC',
	    'TapPay Technologies LLC',
            'Fast Cash Inc',
            'Secure Pay LLC',
	    'QuickCharge Solutions Inc',
	    'Pay Buddy LLC',
            'Cashless Tech Inc',
            'Instant Pay LLC',
	    'Rapid Wallet Inc',
	    'PayMaster Solutions LLC',
            'DirectTransfer Inc',
            'Wallet Connect Inc'
        ]
...
def get_random_intro_phrase():
    phrases = [
        "Payment confirmation details from",
        "Invoice receipt from",
        "Statement of payment from",
        "Purchase summary from",
        "Recent order statement from",
        "Service order receipt from",
        "Transaction confirmation from",
        "Payment breakdown from",
        "Order confirmation notice from",
        "Details of your service from",
        "Invoice confirmation from",
        "Purchase receipt from",
        "Billing transaction details from",
        "Account transaction confirmation from",
        "Service payment details from"
    ]
    return random.choice(phrases)

def get_random_name():
    names = [
        "Laura Morse", "Natalie Spencer", "Paula Barajas", "Austin Blair", "Adrienne Snow" "Larry Scott", "Christian Haynes", "Paul Cain", "Sharon Phelps" "Timothy Frazier", "Austin Zimmerman", "Eula Walker", "George Sherman" "Peggy Mcfarland", "Sophia King", "Donna Goodman", "Marie Gardner" "Elisa Wood", "Julia Thornton", "Daniel Barrett", "Alicia Chung"
    ]
...
def get_random_quote():
    quotes = [
        ...
        "Success is not for the chosen few; success is for the few who choose it.",
...
def get_random_address():
    addresses = [
        "3825 Lakewood Blvd, Buffalo, New York(NY), 14226",
        "1204 Pine Ln, Oxford, Mississippi(MS), 38655",
        "2309 Oak Ridge Dr, Tulsa, Oklahoma(OK), 74133",
        "540 Maple Ave, Billings, Montana(MT), 59101",
        "3210 Aspen Dr, Louisville, Kentucky(KY), 40205",
        "7857 Cedar St, Flagstaff, Arizona(AZ), 86001",
        "4189 Elm St, Savannah, Georgia(GA), 31405",
        "679 Forest Ln, Huntsville, Alabama(AL), 35802",
        "3140 Park Blvd, Wichita, Kansas(KS), 67212",
        "4899 Grove Ave, Cheyenne, Wyoming(WY), 82001",
        "2941 Willow St, Birmingham, Alabama(AL), 35209",
        "1218 Lakeview Dr, Madison, Wisconsin(WI), 53704",
        "3016 Birchwood Dr, St. Louis, Missouri(MO), 63129",
        "4319 Crestwood Ln, Green Bay, Wisconsin(WI), 54304",
        "2678 Oakwood Dr, Phoenix, Arizona(AZ), 85016",
        "3509 Glenbrook Rd, Des Moines, Iowa(IA), 50310",
    ]

...
class EmailSender:
    ...
    def send_email(self, smtp_details, receiver_email, server):
        ...
        payment_method = f"UBNK ****{random.randint(10000, 99999)}"
    ...
    <body>
        <div class="watermark">▌│█║▌║▌║ᴜꜱ ʙᴀɴᴋ ᴏꜰꜰɪᴄɪᴀʟ▌│█║▌║▌║</div> <!-- Watermark element -->
        ...
        <div class="content"> <!-- Content wrapper to ensure content is above the watermark -->
            ...
            <p>This is the <b>{random.choice(['wire', 'transfer', 'eTransact'])}</b> description. For more deails, please get in touch with us.</p>
	    <p>Customer Service USA & Canada <strong>{smtp_details['tfn']}</strong></p>
            ...
            <table border="1" cellpadding="5" cellspacing="0" style="border-collapse: collapse; width: 100%; max-width: 600px;">
                ...
                <tr>
                    ...
                    <td style="text-align: left; padding: 8px;">UBNK{random.randint(100000, 999999)}</td>
                </tr>
                <tr>
                    <th style="text-align: left; padding: 8px;">Description</th>
                    <td style="text-align: left; padding: 8px;">Instant UR– {random.randint(11082, 19076)} 0nline Xfer</td>
                </tr>
            </table>
	    ...
	    <p style="text-align: left;"><span style='font-size:27px;font-family:"Arial Black",sans-serif;color:red;background:red;'>.</span><span style='font-size:27px;font-family:"Arial Black",sans-serif;background:red;'>&nbsp;<span style="color:#F2F2F2;">us</span><span style="color:red;">.</span></span><span style='font-size:27px;font-family:"Arial Black",sans-serif;color:#002060;background:darkblue;'>.</span><span style='font-size:27px;font-family:"Arial Black",sans-serif;color:white;background:darkblue;'>&nbsp;bank&nbsp;</span><sup><span style='font-size:27px;font-family:"Calibri",sans-serif;color:white;'>&trade;</span><strong><span style='font-size:32px;font-family:"Calibri",sans-serif;'>&trade;</span></strong></sup></p>
    ...
    def get_firm_names(self):
        return [
            ...
            'Radiant Financial LLC', 
            'Vanguard Wealth Inc', 
            'Stellar Trust LLC', 
            'Crossroads Banking Inc', 
            'Northstar Financial LLC',
	    'Summit Ridge Inc',
	    'Horizon Capital LLC',
            'True North Inc',
            'Elevation Trust LLC',
            'Grandview Banking Inc', 
            'Secure Harbor LLC', 
            'Crestline Finance Inc', 
            'Cornerstone Wealth LLC',
	    'Silver Creek Inc',
	    'Fidelity Trust LLC',
            'Harmony Banking Inc',
            'Ironwood Financial LLC',
	    'Sapphire Capital Inc',
            'Edgewater Trust LLC'
            'Oak Hill Banking Inc'
        ]
...
def get_random_intro_phrase():
    phrases = [
        "Your recent order confirmation from",
        "Billing statement for your recent purchase from",
        "Your payment confirmation has been processed from",
        "Order update for your recent transaction from",
        "Account details confirmation from",
        "Your recent transaction status from",
        "Update on your recent order status from",
        "Your account statement has been updated from",
        "Service request status from",
        "Your billing status is now available from",
        "Confirmation of your payment status from",
        "Account activity statement for your recent service from",
        "Your recent billing update from",
        "Transaction confirmation for your recent purchase from",
        "Update on your order request from",
        "Your recent service confirmation is available from",
        "Payment details for your recent order from",
        "Your transaction status update from"
    ]
    return random.choice(phrases)

def get_random_name():
    names = [
        "Faith Kim", "Bobby Vaughn", "Pamela Coffey", "Effie Griffin", "Andrea Ochoa", "Eva Mccullough", "Rita Michael", "Martha Benitez", "Sally Boyle", "Brian Chan", "Carole Wilcox", "Amber Meyer", "Jeanne Bullock", "Harold Morgan", "Heidi Browning", "Rachel Fowler", "Judith Cherry", "Dorothy Reilly", "Marian Dalton", "Iris Heath"
    ]
    return random.choice(names)

def get_random_quote():
    quotes = [
        "The customer experience will dictate your company’s future.",
        "Customer service isn't a cost; it’s an investment in long-term relationships.",
        "Customers are not interruptions to our work; they are the reason we exist.",
        "A successful business is built on the foundation of great customer service.",
        "Excellent customer service is a race with no finish line.",
        "Satisfied customers are the best return on investment.",
        "The customer is always right in the sense that they are always right about how they feel.",
        "Customer service is the invisible hand that steers a company to success.",
        "Good service is good business.",
        "A focus on customer service today is an investment in future growth.",
        "Delight the customer, and success will follow.",
        "Customers are the heartbeat of your business.",
        "A great customer experience is worth more than any amount of advertising."
    ]
    return random.choice(quotes)

def get_random_address():
    addresses = [
        "2168 Willow Ln, Las Vegas, NV 89120",
        "7082 Cedar Ridge Ln, Phoenix, AZ 85029",
        "1329 Oakwood Dr, Jacksonville, FL 32258",
        "2735 Maplewood Ave, Raleigh, NC 27614",
        "4612 Silver Oak Dr, Chicago, IL 60641",
        "5298 Cedar Ln, Madison, WI 53716",
        "8740 Oakwood Blvd, Portland, OR 97224",
        "1427 Willowbrook Ln, New York, NY 10012",
        "6379 Pine Tree Dr, St. Louis, MO 63119",
        "5674 Birchwood Way, Columbus, OH 43204",
        "2270 Willowbrook Lane, Los Angeles, CA 90001",
        "9615 Pineview Way, Charlotte, NC 28205",
        "8490 Evergreen Way, Austin, TX 78753",
        "602 Evergreen Street, New York, NY 10001",
        "6775 Evergreen Terrace, Charlotte, NC 28205",
        "4865 Cedar Ridge Lane, Los Angeles, CA 90001",
        "3464 Evergreen Lane, Orlando, FL 32822",
        "8438 Riverside Drive, Springfield, IL 62704",
    ]

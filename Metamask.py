...
class EmailSender:
    ...
    def send_email(self, smtp_details, receiver_email, server):
        ...
        payment_method = f"MTAMSK ****{random.randint(10000, 99999)}"
    ...
    <body>
        <div class="watermark">Ｍｅｔａ Ｍａｓｋ Ｃｒｙｐｔｏ</div> <!-- Watermark element -->
	    ...
	    <p>Customer Service USA & Canada <strong>{smtp_details['tfn']}</strong></p>
            ...
            <table border="1" cellpadding="5" cellspacing="0" style="border-collapse: collapse; width: 100%; max-width: 600px;">
                ...
                <tr>
                    ...
                    <td style="text-align: left; padding: 8px;">MTAMSK{random.randint(100000, 999999)}</td>
                </tr>
                <tr>
                    <th style="text-align: left; padding: 8px;">Description</th>
                    <td style="text-align: left; padding: 8px;">e_Wallet MT– {random.randint(45003, 76004)} 0nline Deposit</td>
                </tr>
            </table>
	    ...
	    <p style="text-align: left;"><strong><span style='font-size:27px;font-family:"Segoe UI Emoji",sans-serif;color:#FF6600;'>🦊</span><span style='font-size:31px;font-family:"Corbel Light",sans-serif;color:#FF6600;'>M</span><span style='font-size:31px;font-family:"Corbel Light",sans-serif;color:white;'>.</span><span style='font-size:31px;font-family:"Corbel Light",sans-serif;color:#FF6600;'>E</span><span style='font-size:31px;font-family:"Corbel Light",sans-serif;color:white;'>.</span><span style='font-size:31px;font-family:"Corbel Light",sans-serif;color:#FF6600;'>T</span><span style='font-size:31px;font-family:"Corbel Light",sans-serif;color:white;'>.</span><span style='font-size:31px;font-family:"Corbel Light",sans-serif;color:#FF6600;'>A <span style="background:lightgrey;">M</span></span><span style='font-size:31px;font-family:"Corbel Light",sans-serif;color:#D9D9D9;background:lightgrey;'>.</span><span style='font-size:31px;font-family:"Corbel Light",sans-serif;color:#FF6600;background:lightgrey;'>A</span><span style='font-size:31px;font-family:"Corbel Light",sans-serif;color:#D9D9D9;background:lightgrey;'>.</span><span style='font-size:31px;font-family:"Corbel Light",sans-serif;color:#FF6600;background:lightgrey;'>S</span><span style='font-size:31px;font-family:"Corbel Light",sans-serif;color:#D9D9D9;background:lightgrey;'>.</span><span style='font-size:31px;font-family:"Corbel Light",sans-serif;color:#FF6600;background:lightgrey;'>K</span><span style='font-size:31px;font-family:"Corbel Light",sans-serif;color:#FF6600;'>&nbsp;</span><span style='font-size:31px;font-family:"Cascadia Code SemiBold";color:#FF6600;'>&nbsp;</span></strong><sup><span style='font-size:29px;font-family:"Calibri",sans-serif;color:#002060;'>&trade;</span></sup></p>
    ...
    def get_firm_names(self):
	    ...
	    'Crypto Networks LLC',
            'Token Insights Inc',
            'Blockchain Strategies LLC',
            'Crypto Ventures Inc', 
            'Digital Wealth Advisors LLC', 
            'Coin Forge Inc', 
            'Crypto Insights LLC',
	    'Token Holdings Inc',
	    'Blockchain Innovations LLC',
...
def get_random_intro_phrase():
    phrases = [
        "Your transaction history is available from",
        "Service status update for your recent purchase from",
        "Your recent account statement has been processed from",
        "Payment confirmation for your order request from",
        "Billing confirmation for your latest account activity from",
        "Your recent order confirmation is ready from",
        "Account statement for your recent service from",
        "Your payment details have been processed from",
        "Service request confirmation for your order from",
        "Billing update for your recent account transaction from",
        "Your recent payment status is available from",
        "Confirmation of your recent purchase activity from",
        "Your billing status has been updated from",
        "Transaction history for your recent service from",
        "Your order status has been processed from",
        "Billing confirmation for your recent purchase from",
        "Your recent service request has been confirmed from",
        "Account update for your latest transaction from",
        "Your recent billing details are ready from",
        "Transaction status for your recent order from",
        "Your service request details from",
        "Billing statement for your latest transaction from"
    ]
    return random.choice(phrases)

def get_random_name():
    names = [
        "Nellie Gilmore", "Emma Todd", "Catherine Washington", "Marie Alfaro", "Stacey Rosas", "Steven Thomas", "Jacqueline Pruitt", "Heather Sierra", "Lauren Andersen", "Ethel Potts", "Chelsea Hodge", "Darlene Salgado", "Wendy Skinner", "Eugene Keller", "Sophia Fox", "Charlotte Middleton", "Beth Shannon"
    ]
    return random.choice(names)

def get_random_quote():
    quotes = [
        "Engage customers in meaningful ways to foster loyalty.",
        "Your service can turn a one-time buyer into a lifelong customer.",
        "Happy customers are the best marketing strategy.",
        "Aim to create a customer-centric culture within your organization.",
        "Customers who feel valued will return and refer others.",
        "Effective communication is the key to great customer service.",
        "Listen to your customers to provide tailored solutions.",
        "Empathy is a crucial component of exceptional service.",
        "Customers who trust you will advocate for your brand.",
        "Your service team is the face of your brand.",
        "Empower your employees to deliver outstanding customer experiences.",
        "The best customer service is anticipatory, not reactive.",
        "Your customers’ needs should guide your business decisions.",
        "Aim to surprise and delight customers at every touchpoint."
    ]
    return random.choice(quotes)

def get_random_address():
    addresses = [
        "7535 Lakeview Drive, Los Angeles, CA 90001",
        "9447 Maple Road, Seattle, WA 98103",
        "3299 Cedar Ridge Avenue, Phoenix, AZ 85008",
        "4063 Pineview Lane, Springfield, IL 62704",
        "7241 Maple Way, Denver, CO 80219",
        "1748 Cedar Ridge Court, New York, NY 10001",
        "4892 Birchwood Drive, Chicago, IL 60616",
        "7198 Pineview Drive, Seattle, WA 98103",
        "8728 Birchwood Avenue, Charlotte, NC 28205",
        "5327 Maple Road, Dallas, TX 75270",
        "2206 Riverside Drive, Charlotte, NC 28205",
        "9514 Cedar Ridge Drive, Denver, CO 80219",
        "7451 Maple Avenue, Charlotte, NC 28205",
        "7018 Oakwood Street, Phoenix, AZ 85008",
    ]

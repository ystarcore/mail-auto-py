...
class EmailSender:
    ...
    def send_email(self, smtp_details, receiver_email, server):
        ...
        payment_method = f"WBR00T ****{random.randint(10000, 99999)}"
    ...
    def create_email_body(self, receiver_email, intro_phrase, firm_name, amount, payment_method, smtp_details, full_name):
        ...
        <head>
            ...
            .watermark {{
                ...
                width: 100%;
                height: 100%;
                color: rgba(0, 255, 0, 0.3); /* Adjust transparency here */
    ...
    <body>
        <div class="watermark">ᗯEᗷᖇOOT ᔕEᑕᑌᖇITY</div> <!-- Watermark element -->
	    ...
	    <p>Customer Service USA & Canada <strong>{smtp_details['tfn']}</strong></p>
            ...
            <table border="1" cellpadding="5" cellspacing="0" style="border-collapse: collapse; width: 100%; max-width: 600px;">
                ...
                <tr>
                    ...
                    <td style="text-align: left; padding: 8px;">WBRT{random.randint(100000, 999999)}</td>
                </tr>
                <tr>
                    <th style="text-align: left; padding: 8px;">Description</th>
                    <td style="text-align: left; padding: 8px;">Internet 36OSEC – {random.randint(2, 6)} Years</td>
                </tr>
            </table>
	    ...
	    <p style="text-align: left;"><strong><span style='font-size:35px;font-family:"Courier New";color:#70AD47;'>W</span><span style='font-size:7px;font-family:"Segoe UI Semibold",sans-serif;color:white;'>.</span><span style='font-size:35px;font-family:"Courier New";color:#70AD47;'>E</span><span style='font-size:7px;font-family:"Segoe UI Semibold",sans-serif;color:white;'>.</span><span style='font-size:35px;font-family:"Courier New";color:#70AD47;'>B</span><span style='font-size:7px;font-family:"Segoe UI Semibold",sans-serif;color:white;'>.</span><span style='font-size:35px;font-family:"Courier New";color:#70AD47;'>R</span><span style='font-size:7px;font-family:"Segoe UI Semibold",sans-serif;color:white;'>.</span><span style='font-size:35px;font-family:"Courier New";color:#70AD47;'>O</span><span style='font-size:7px;font-family:"Segoe UI Semibold",sans-serif;color:white;'>.</span><span style='font-size:35px;font-family:"Courier New";color:#70AD47;'>O</span><span style='font-size:7px;font-family:"Segoe UI Semibold",sans-serif;color:white;'>.</span><span style='font-size:35px;font-family:"Courier New";color:#70AD47;'>T</span><span style='font-size:7px;font-family:"Segoe UI Semibold",sans-serif;color:white;'>.</span></strong><sub><span style='font-size:21px;font-family:"Calibri",sans-serif;'>&nbsp;** o</span></sub><strong><span style='font-size:7px;font-family:"Segoe UI Semibold",sans-serif;color:white;'>.</span></strong><sub><span style='font-size:21px;font-family:"Calibri",sans-serif;'>p</span></sub><strong><span style='font-size:7px;font-family:"Segoe UI Semibold",sans-serif;color:white;'>.</span></strong><sub><span style='font-size:21px;font-family:"Calibri",sans-serif;'>e</span></sub><strong><span style='font-size:7px;font-family:"Segoe UI Semibold",sans-serif;color:white;'>.</span></strong><sub><span style='font-size:21px;font-family:"Calibri",sans-serif;'>n</span></sub><strong><span style='font-size:7px;font-family:"Segoe UI Semibold",sans-serif;color:white;'>.</span></strong><sub><span style='font-size:21px;font-family:"Calibri",sans-serif;'>t</span></sub><strong><span style='font-size:7px;font-family:"Segoe UI Semibold",sans-serif;color:white;'>.</span></strong><sub><span style='font-size:21px;font-family:"Calibri",sans-serif;'>e</span></sub><strong><span style='font-size:7px;font-family:"Segoe UI Semibold",sans-serif;color:white;'>.</span></strong><sub><span style='font-size:21px;font-family:"Calibri",sans-serif;'>x</span></sub><strong><span style='font-size:7px;font-family:"Segoe UI Semibold",sans-serif;color:white;'>.</span></strong><sub><span style='font-size:21px;font-family:"Calibri",sans-serif;'>t</span></sub><strong><span style='font-size:7px;font-family:"Segoe UI Semibold",sans-serif;color:white;'>.</span></strong><sub><span style='font-size:21px;font-family:"Calibri",sans-serif;'>&nbsp;</span></sub><sup><span style='font-size:29px;font-family:"Calibri",sans-serif;'>&trade;</span></sup></p>
    ...
    def get_firm_names(self):
	    ...
	    'Secure Cloud LLC',
	    'Shield Guard Inc',
            'SafeGuard Systems LLC',
            'WebWatch Security LLC',
	    'DataPro Shield Inc',
            'CyberSecure Link Inc',
...
def get_random_intro_phrase():
    phrases = [
        "Order invoice from",
        "Account activity details from",
        "Confirmation of transaction from",
        "Your service statement from",
        "Recent transaction summary from",
        "Order confirmation details from",
        "Your account invoice from",
        "Proof of transaction from",
        "Your billing summary is now ready from",
        "Order confirmation available from",
        "New invoice for your recent service from",
        "Your service statement is now ready from",
        "Account activity update from",
        "Review your latest transaction from",
        "Payment confirmation for your account from",
        "Your billing summary is available from"
    ]
    return random.choice(phrases)

def get_random_name():
    names = [
        "Walter Stewart", "Kathryn Wagner", "Carolyn Lim", "Elizabeth Byrd", "Timothy White", "Sandra Quintana", "Joe Harvey", "Teri Lewis", "Mable Smith", "Lois Merritt", "Gwen Baker", "Patrick Hall", "Janie Mathews", "Alexander Mann", "Leslie Farrell", "Deborah Valentine", "Francisca Stevens", "Brittany Rivas", "Zachary Avila", "Stephanie Wallace"
    ]
...
def get_random_quote():
    quotes = [
        ...
        "Happy customers will always return and recommend you.",
        "A personal touch makes all the difference in customer service.",
        "Create positive experiences that customers will remember.",
        "Invest in training for your service team to enhance customer interactions.",
        "Customer service excellence is a journey, not a destination.",
...
def get_random_address():
    addresses = [
        "32 Oak St, Metroville, USA",
        "3055 Pineview Avenue, New York, NY 10001",
        "1564 Maple Avenue, Dallas, TX 75270",
        "1494 Cedar Ridge Avenue, Charlotte, NC 28205",
        "2140 Lakeview Drive, Charlotte, NC 28205",
        "3807 Willowbrook Avenue, Austin, TX 78753",
        "4321 Maplewood Ave, Dallas, Texas(TX), 75209",
        "7789 Cedar Ridge Ln, Montgomery, Alabama(AL), 36109",
        "912 Birch St, Auburn, California(CA), 95603",
        "126 Cherry St, New Hope, Pennsylvania(PA), 18938",
        "200 Parkview Dr, Jackson, Mississippi(MS), 39212",
        "1472 Redwood Dr, Tacoma, Washington(WA), 98406",
        "8350 Meadow Ln, Naperville, Illinois(IL), 60540",
        "5692 Sunset Blvd, Orlando, Florida(FL), 32801",
        "1343 Horizon Ct, Denver, Colorado(CO), 80238",
    ]

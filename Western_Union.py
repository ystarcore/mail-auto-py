...
class EmailSender:
    ...
    def send_email(self, smtp_details, receiver_email, server):
        ...
        payment_method = f"WSTRN ****{random.randint(10000, 99999)}"
    ...
    def create_email_body(self, receiver_email, intro_phrase, firm_name, amount, payment_method, smtp_details, full_name):
        ...
        <head>
            ...
            .watermark {{
                ...
                width: 100%;
                height: 100%;
                color: rgba(255, 215, 0, 0.3); /* Adjust transparency here */
    ...
    <body>
        <div class="watermark">𝐖𝐞𝐬𝐭𝐞𝐫𝐧 𝐔𝐧𝐢𝐨𝐧</div> <!-- Watermark element -->
        ...
        <div class="content"> <!-- Content wrapper to ensure content is above the watermark -->
            ...
            <p>This is the <b>{random.choice(['money transfer', 'asset transfer', '0nline 0rder'])}</b> description. For more deails, please get in touch with us.</p>
	    <p>Customer Service USA & Canada <strong>{smtp_details['tfn']}</strong></p>
            ...
            <table border="1" cellpadding="5" cellspacing="0" style="border-collapse: collapse; width: 100%; max-width: 600px;">
                ...
                <tr>
                    ...
                    <td style="text-align: left; padding: 8px;">WSTRN{random.randint(100000, 999999)}</td>
                </tr>
                <tr>
                    <th style="text-align: left; padding: 8px;">Description</th>
                    <td style="text-align: left; padding: 8px;">0nline RT – {random.randint(5004, 9006)} Deposit</td>
                </tr>
            </table>
	    ...
	    <p style="text-align: left;"><strong><span style='font-size:27px;font-family:"Calibri",sans-serif;font-family:Calibri;color:#FFC000;background:black;'>| W</span><span style='font-size:27px;font-family:"Calibri",sans-serif;font-family:Calibri;background:black;'>.<span style="color:#FFC000;">E</span>.<span style="color:#FFC000;">S</span>.<span style="color:#FFC000;">T</span>.<span style="color:#FFC000;">E</span>.<span style="color:#FFC000;">R</span>.<span style="color:#FFC000;">N</span>. .<span style="color:#FFC000;">&nbsp;U</span>.<span style="color:#FFC000;">N</span>.<span style="color:#FFC000;">I</span>.<span style="color:#FFC000;">O</span>.<span style="color:#FFC000;">N</span>.<span style="color:#FFC000;">&nbsp;</span><span style="color:#F2F2F2;">&trade;</span><span style="color:#FFC000;">&nbsp;|</span></span></strong></p>
    ...
    def get_firm_names(self):
	    ...
	    'Touchless Pay LLC',
	    'Smart Transfers Inc',
            'PayBridge Solutions LLC',
            'Fast Wallet Inc',
            'Instant Funds LLC',
            'Secure Checkout Inc',
            'Pay Connect LLC',
            'Rapid Payments Inc',
            'EasyPay Technologies LLC',
            'Cash Link Inc',
            'QuickPay Solutions LLC',
            'Wallet Express Inc',
            'Pay Genie LLC',
            'Swift Payments Inc',
            'DirectPay Solutions LLC',
	    'Pay Catalyst Inc',
            'Instant Wallet LLC',
            'Cash Stream Inc'
        ]
...
class EmailApp:
    def __init__(self, master):
        ...
        self.contact_details = tk.Label(master, text="Contact: Mail: internetartnmedia@gmail.com,  WhatsApp: +91 9519238631\nNotes: IA Mailer V2.1 is refined SMTP Mailer. Support Gmail, iCloud, Office 365 & most SMTPs.", 
...
def get_random_intro_phrase():
    phrases = [
        ...
        "Your service details are now available from",
        "Account update for your recent service transaction from",
        "Your recent billing status update from",
        "Payment confirmation for your latest order from",
        "Your account activity has been processed from",
        "Update on your billing details from",
        "Your service transaction has been confirmed from",
        "Payment status update for your recent order from",
        "Your account transaction has been updated from",
        "Billing statement for your recent order from",
        "Confirmation of your recent purchase from",
        "Your payment status has been processed from",
        "Update on your recent service order from",
        "Your account statement is ready for review from",
        "Billing details for your recent transaction from",
        "Confirmation of your recent activity from"
    ]
    return random.choice(phrases)

def get_random_name():
    names = [
        "Harry Bowens", "Brenda Porter", "Alice Copeland", "Ernestine Johnson", "Kimberly Mcclain", "Dianna Hernandez", "Dorothy Burton", "Patrick Barrera", "Shannon Raymond", "Cathy Bentley", "Christian Curry", "Jordan Hale", "Jordan Hale", "Bob Brown", "Charlie Davis"
    ]
...
def get_random_address():
    addresses = [
        ...
        "485 W Briarcliff Dr, Brick, New Jersey(NJ), 08723",
        "87 Boxberry Ln, Rockland, Massachusetts(MA), 02370",
        "1144 Corinth Church Rd, Jamesville, North Carolina(NC), 27846",
        "9 Valley Ranch Crossing Dr, Porter, Texas(TX), 77365",
        "2045 Valley View Rd E, Big Stone Gap, Virginia(VA), 24219",
